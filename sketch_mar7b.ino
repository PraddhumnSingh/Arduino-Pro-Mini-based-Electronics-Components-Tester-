...
void setup()
{
  ...
  pinMode(TestKeyPin, INPUT);
   ...
   display.setTextSize(1);
    ...
    lcd_set_cursor(4, 0);
    lcd_string("1.08.004");
    lcd_set_cursor(1, 16);lcd_string(" __");
    lcd_set_cursor(2, 16);lcd_string("|[]|"); 		
 
    lcd_set_cursor(3, 16);lcd_string("|oo|");
	 lcd_set_cursor(4, 16);lcd_string(" ~~ ");
   lcd_set_cursor(5, 0);lcd_string("PRADDHUMN SINGH");
